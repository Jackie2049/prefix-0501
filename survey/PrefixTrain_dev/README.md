...
- **Install dependencies:**
    ...
    - **Option 2: manual installation**
        ...
        - Alpa 0.1.5 (Baseline system): 
            ```
            export LD_LIBRARY_PATH=./external/spack/opt/spack/linux-ubuntu20.04-icelake/gcc-9.5.0/cuda-11.6.2-zczko455kcqmm5obdx5hgmmdcuczwvcr/targets/x86_64-linux/lib/:$LD_LIBRARY_PATH
            cd external/alpa
            pip3 install -r requirements.txt
            ...
            pip3 install https://github.com/alpa-projects/alpa/releases/download/v0.1.5/jaxlib-0.3.5%2Bcuda113.cudnn820-cp38-none-manylinux2010_x86_64.whl
            sudo apt-get update 
...
conda activate aceso
source ../external/spack/share/spack/setup-env.sh 
spack install cuda@11.6
