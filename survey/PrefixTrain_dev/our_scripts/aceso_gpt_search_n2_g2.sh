...
#### Paths ####
DATABASE_PATH=${ROOT_PATH}/profiler/profiled-time-eurosys-new/
RESULT_PATH=${ROOT_PATH}/logs-large/aceso_${exp_setting}_n2_g2/
...
do  
    ...
    python3 aceso_search.py \
        ...
        2>&1 | tee ${LOG_PATH}log_${model_name}_${model_size}_budget${budget}_${memory_limit}_${CURRENT_TIME}.log
