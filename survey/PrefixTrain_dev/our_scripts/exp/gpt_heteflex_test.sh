...
max_gpus_per_stage=12
start_num_stages=2
end_num_stages=12
min_num_pipeline=1
max_num_pipeline=1
#### Paths ####
DATABASE_PATH=/home/ymj/project/MyMindSpeed_dp_hete/npu_profiler/profiled-time-hete/test/
RESULT_PATH=${ROOT_PATH}/logs-large/temp_/
RESULT_PATH=${ROOT_PATH}/logs-large/nodp_recomp_search_budget${exp_setting}_32GPU_${min_num_pipeline}_${max_num_pipeline}_dp_${CURRENT_TIME}/${op_grain}/

save_prefix="temp"
# save_prefix=${exp_setting}_pipelinerange_${min_num_pipeline}_${max_num_pipeline}_dp_nodp_recomp_search_budget${search_budget}_${CURRENT_TIME}
...
do  
    ...
    python3 aceso_search_heteflex.py \
        ...
        --dp-find-pipeline \
        --elastic-time \
        --num-ops-each-layer 10 \
        --save-brief-format \
        --max-cp 1 \
        --easy-mode \
        --add-action-tp-dp-exchange \
        # --add-action-tp-cp-dp-exchange \
