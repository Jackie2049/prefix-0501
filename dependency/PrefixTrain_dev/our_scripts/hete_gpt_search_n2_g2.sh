...
#### Paths ####
DATABASE_PATH=${ROOT_PATH}/profiler/profiled-time-hete_12_9/
# RESULT_PATH=${ROOT_PATH}/logs-large/temp_/
RESULT_PATH=${ROOT_PATH}/logs-large/aceso_${exp_setting}_gpu_4/${op_grain}/
...
# save_prefix="temp"
save_prefix="diff-order-balance_v1_comm_revised_v2_recom_revised_v2"
