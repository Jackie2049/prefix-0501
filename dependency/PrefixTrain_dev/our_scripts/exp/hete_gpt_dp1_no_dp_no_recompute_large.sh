...
RESULT_PATH=${ROOT_PATH}/logs-large/nodp_norecomp_search_budget${exp_setting}_32GPU_${min_num_pipeline}_${max_num_pipeline}_dp_${CURRENT_TIME}/${op_grain}/

save_prefix="temp"
save_prefix=${exp_setting}_pipelinerange_${min_num_pipeline}_${max_num_pipeline}_dp_nodp_norecomp_search_budget${search_budget}_${CURRENT_TIME}
