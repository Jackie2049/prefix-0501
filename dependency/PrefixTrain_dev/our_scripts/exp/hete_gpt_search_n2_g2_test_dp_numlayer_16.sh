...
do  
    ...
    nohup python3 aceso_search_dp_hete.py \
        ...
        --use-cache \
        >/home/ymj/project/Aceso/log/motivation_exp/910Ax1x1_910B2x1x1_${model_name}_num_layer_${num_layer}_gbs_${gbs}_dp2_mbs_1.log 1>&1
