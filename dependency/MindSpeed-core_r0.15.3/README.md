...
- [Mar 26, 2026]: 🚀 MindSpeed Core 支持Mcore 0.15.3版本。
- ⚠️ **升级注意**：相比 2.3.0_core_r0.12.1 分支megatron会多创建一个 `intra_dist_opt_instance` 通信域，显存占用增加约 `2 * HCCL_BUFFSIZE`（默认 400MB），显存敏感场景下存在 OOM 风险。
