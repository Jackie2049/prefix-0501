...
|  开源引入  |                           <https://github.com/NVIDIA/Megatron-LM>                            |          mindspeed/optimizer/distrib_optimizer.py          |      <https://github.com/NVIDIA/Megatron-LM/blob/main/docs/zh/user-guide/features/dist_optimizer.md>      | distributed_optimizer_zero3_init文档字符串参数说明 |
