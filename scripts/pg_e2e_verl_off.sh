#!/bin/bash
# PG E2E GRPO — verl pipeline, PG OFF baseline
...
OUTPUT_DIR=/home/zxw/rollout-prefix/pg_e2e_output/pg_off

echo "========================================"
echo "Running PG OFF (baseline) — verl pipeline"
echo "========================================"
